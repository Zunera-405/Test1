...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Zunera-405/Test1/blob/main/Z.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/Zunera-405/Test1/blob/main/Z.txt").text
    if id in httpCaht:
